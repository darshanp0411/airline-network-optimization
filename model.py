...
if os.path.exists("all_data.zip"):
    ...
    print("✅ SUCCESS: Unzipped data into 'flight_data' folder.")
else:
    print("⚠️ WAITING: Please upload 'all_data.zip' to the sidebar first!")
...
# 
#     print(f"🧠 Brain is processing {len(files)} data files...")
# 
#     df_list = []
#     for f in files:
#         try:
...
#     ]
#     stats['Competition_Status'] = np.select(conditions, ['⚔️ Price War', '⚠️ Concentrated'], default='👑 Monopoly')
# 
#     return stats
# 
...
# 
# if df is not None:
#     st.title("✈️ Airline Network Strategic (AI Powered)")
# 
...
# 
#             tab1, tab2, tab3, tab4 = st.tabs(["🗺️ Profit Map", "📋 Full Data Grid", "🔥 Seasonality", "🔮 AI Forecast"])
# 
#             with tab1:
...
print(f"🚀 BRAIN IS LIVE: {public_url}")
